...
questions_templates = {
    "food_identification": [
        ...
        "照片上的食物是什么？", "这张图里的食物叫什么？", "这是什么食物，从图片看？", "请告诉我图片里食物的名字？"
    ],
    "quantity_inquiry": [
        ...
        "请问图片中的食物数量是多少？", "你知道照片里有多少这种食物吗？", "看图片，能数出这种食物有多少吗？",
        "这张图里的食物有多少个？", "请说出图片中这种食物的数量。"
    ],
    "weight_inquiry": [
    ...
    "nutritional_value": [
        ...
        "你知道图片里这种食物有什么营养成分吗？", "请说出图片中这种食物的营养价值。"
    ],
    "recipe_recommendations": [
        ...
        "你知道图片里这种食物的烹饪方法吗？", "请说出图片中这种食物的烹饪建议。"
    ]
}
